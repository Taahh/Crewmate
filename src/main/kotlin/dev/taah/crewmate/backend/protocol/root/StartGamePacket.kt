...
class StartGamePacket(nonce: Int) : AbstractPacket<StartGamePacket>(0x01, nonce) {
    var gameCode: GameCode? = null
    override fun processPacket(packet: StartGamePacket, connection: PlayerConnection) {
        if (gameCode != null) {
